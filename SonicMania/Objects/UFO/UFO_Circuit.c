...
void UFO_Circuit_Draw(void)
{
    ...
    if (self->zdepth >= 0x4000) {
        ...
        RSDK.AddMeshFrameTo3DScene(self->ufoAnimator.animationID, UFO_Circuit->sceneIndex, &self->ufoAnimator, S3D_SOLIDCOLOR_SHADED_SCREEN,
                                   &self->matWorld, &self->matNormal, 0xFFFFFF);
        RSDK.AddMeshFrameTo3DScene(UFO_Circuit->emeraldModel, UFO_Circuit->sceneIndex, &self->ufoAnimator, S3D_SOLIDCOLOR_SHADED_SCREEN,
                                   &self->matWorld, &self->matNormal, 0xFFFFFF);
